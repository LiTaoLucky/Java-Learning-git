...
public class StudentView {
    ...
    /*
     * 后面会反复键盘录入,所以我们没必要执行一个方法就new一次Scanner
     * 所以将Scanner对象放到成员位置
     * */
    ...
    private void findAllStudent() {
        ...
        if (count == 0) {
            System.out.println("对不起,现在班里没有学生,待开班......");
        } else {
